...
<body class="stretched">
	...
	<script>
		...
		$(document).ready(function(){
			var elementOffset = $('#sport-type-container').offset().top;
		...
		function myFunction() {
			...
			console.log(elementOffset,  distance, scrollTop );
		  if (distance <= 0 ) {
			
			
			$('#sport-type-container').addClass('sticky');
		  } else {
			
			
			$('#sport-type-container').removeClass('sticky');
		  }
		}
		})
